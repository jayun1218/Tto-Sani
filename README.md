...
- **실시간 지출 감시자 (Budget Watchdog)**: 과거 데이터 대비 급격한 지출 증가를 감지하여 대시보드에 즉시 경고 및 페르소나 피드백 전송.
...
- **카드형 대시보드**: 개별 구독 서비스를 현대적인 카드 그리드 레이아웃으로 시각화하여 한눈에 관리.
- **월간 고정비 집계**: 매달 나가는 총 구독료를 실시간으로 집계하여 고정 지출 최적화 도모.
